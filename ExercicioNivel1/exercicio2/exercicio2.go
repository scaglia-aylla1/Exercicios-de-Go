...
//1. Identificador "x" deverá ter tipo int  2. Identificador "y" deverá ter tipo string
//3. Identificador "z" deverá ter tipo bool
//Na função main: 1. Demonstre os valores de cada identificador
...
func main(){
	...
	fmt.Printf("Type y: %q\n",y)
	fmt.Printf("Type z: %v\n",z)
	fmt.Println("Chamamos de valor zero")
}